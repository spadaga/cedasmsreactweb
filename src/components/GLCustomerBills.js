...
import GLCustomerBillscomponent from './GLCustomerBillscomponent';

const GLCustomerBills = () => {
  ...
  return (
    <MasterLayout title="Customer Bills ">
      <Box sx={{ padding: '20px', border: `1px solid ${theme.palette.divider}`, borderRadius: '5px', backgroundColor: theme.palette.background.paper }}> {/* Use theme divider and background */}
       ...
       <GLCustomerBillscomponent/>
      </Box>
    </MasterLayout>
  );
};

export default GLCustomerBills;