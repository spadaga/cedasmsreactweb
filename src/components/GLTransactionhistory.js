...
import GLTransactionhistoryComponent from './GLTransactionhistoryComponent';

const GLTransactionhistory = () => {
  ...
  return (
    <MasterLayout title="Transaction History ">
      ...
      <GLTransactionhistoryComponent/>
      </Box>
    </MasterLayout>
  );
};

export default GLTransactionhistory;