      ...
      />
          ...
          >
            <StyledLegend>
              <Typography variant="subtitle1">
                ...
                <Tooltip title="Primary Account">
                  <InfoIcon
                    sx={{ fontSize: "medium", ml: 1, verticalAlign: "middle" }}
                  />
                </Tooltip>
              </Typography>
            </StyledLegend>
            ...
            >
              <Grid item xs={12} sm={3}>
                <Typography variant="body2">
                  CEDNET CUSTOMER <span style={{ color: "red" }}>*</span>
                </Typography>
              </Grid>
              <Grid item xs={12} sm={9}>
                <StyledAutocomplete
            ...
            >
              <Grid item xs={12} sm={3}>
                <Typography variant="body2">
                  CEDNET ACCOUNT <span style={{ color: "red" }}>*</span>
                </Typography>
              </Grid>
              <Grid item xs={12} sm={9}>
                <StyledAutocomplete
                ...
                <Tooltip title="This account is used for GL product catalog price refresh.">
                  ...
                  >
                    ...
                    <Typography
                      variant="body2"
                      sx={{ color: "#d32f2f", fontSize: "0.8rem" }}
                    >
