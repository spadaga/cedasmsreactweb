...
import GLCustomerCreditDetailsComponent from './GLCustomerCreditDetailsComponent';

const GLCustomerCreditDetails = () => {
  ...
  return (
    <MasterLayout title="Customer Credit Details">
      ...
      <GLCustomerCreditDetailsComponent/>
      </Box>
    </MasterLayout>
  );
};

export default GLCustomerCreditDetails;