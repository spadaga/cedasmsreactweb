...
import LocationComponent from "../controls/LocationComponent";
        ...
        <Box sx={{ minHeight: "100vh", width: "100%", display: "flex" }}>
          ...
          >
            ...
            >
              ...
              />
              <LocationComponent />
              <Box sx={{ width: "100%", display: "flex", justifyContent: "center", padding: '0px' }}>
                <Box sx={{ width: '250px', borderRight: `1px solid ${theme.palette.divider}`, padding: '0px', height: '100%', overflowY: 'auto', flexShrink: 0 }} >
                  <GLFilterPanel
                  ...
                  >
                      ...
                      >
                        <FormControl
                          ...
                          sx={{
                            ...
                            backgroundColor: theme.palette.action.selected, // Use theme color
                          }}
                        >
                          <Select
                    ...
                    <Grid item xs={12} sm={4} sx={{ textAlign: "center" }}>
                      <Typography variant="body2" sx={{ fontSize: "0.8rem" }}>
                        Showing {startIndex + 1}-{endIndex} of {filteredProducts.length} items
                      </Typography>
                    </Grid>
